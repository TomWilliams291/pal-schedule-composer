// PAL Schedule Composer - service worker.
//
...
const CACHE_NAME = 'pal-composer-shell-v29';
const APP_SHELL = [
  './',
  './index.html',
  ...
  event.respondWith(
    caches.match(req).then(cached => {
      ...
      return fetch(req).then(resp => {
        // Opportunistically cache any same-origin GET so subtree
        // resources (favicon, etc.) work offline after first visit.
        if (resp.ok) {
